...
static const char * const ch_not_tashizan = "ÇΩÇµÇ¥ÇÒÇ≈ÇÕÇ†ÇËÇ‹ÇπÇÒÅB";
static const char * const ch_not_kakezan = "Ç©ÇØÇ¥ÇÒÇ≈ÇÕÇ†ÇËÇ‹ÇπÇÒÅB";
static const char * const ch_not_hikizan = "Ç–Ç´Ç¥ÇÒÇ≈ÇÕÇ†ÇËÇ‹ÇπÇÒÅB";
static const char * const ch_not_warizan = "ÇÌÇËÇ¥ÇÒÇ≈ÇÕÇ†ÇËÇ‹ÇπÇÒÅB";
...
std::string ChGetJpnNumberFixed(CH_Value num)
{
    ...
    ChReplaceString(str, "Ç∂Ç„Ç§ÇøÇÂÇ§", "Ç∂Ç„Ç¡ÇøÇÂÇ§");
    ChReplaceString(str, "Ç¢ÇøÇØÇ¢", "Ç¢Ç¡ÇØÇ¢");
    ChReplaceString(str, "Ç∂Ç„Ç§ÇØÇ¢", "Ç∂Ç„Ç¡ÇØÇ¢");
    ChReplaceString(str, "Ç¢ÇøÇ±Ç§", "Ç¢Ç¡Ç±Ç§");
    ChReplaceString(str, "Ç∂Ç„Ç§Ç±Ç§", "Ç∂Ç„Ç¡Ç±Ç§");
    ChReplaceString(str, "Ç¢ÇøÇ©ÇÒ", "Ç¢Ç¡Ç©ÇÒ");
    ChReplaceString(str, "Ç∂Ç„Ç§Ç©ÇÒ", "Ç∂Ç„Ç¡Ç©ÇÒ");
    ChReplaceString(str, "Ç¢ÇøÇπÇ¢", "Ç¢Ç¡ÇπÇ¢");
    ChReplaceString(str, "Ç∂Ç„Ç§ÇπÇ¢", "Ç∂Ç„Ç¡ÇπÇ¢");
    ChReplaceString(str, "Ç¢ÇøÇ≥Ç¢", "Ç¢Ç¡Ç≥Ç¢");
    ChReplaceString(str, "Ç∂Ç„Ç§Ç≥Ç¢", "Ç∂Ç„Ç¡Ç≥Ç¢");
    return str;
}
