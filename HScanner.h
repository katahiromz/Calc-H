...
namespace Calc_H
{
    ...
    public:
        ...
        Token get_token(TokenValue& info)
        {
            ...
            if (lexeme("ｔａｎｈ"))                     return (T_TANH);
            if (lexeme("ｔａｎ"))                       return (T_TAN);
            if (lexeme("ｓｉｎｈ"))                     return (T_SINH);
            if (lexeme("ｓｉｎ"))                       return (T_SIN);
            if (lexeme("ｌｏｇ１０"))                   return (T_LOG10);
            if (lexeme("ｌｏｇ"))                       return (T_LOG);
            if (lexeme("ｌｎ"))                         return (T_LOG);
            if (lexeme("ｆａｂｓ"))                     return (T_ZETTAICHI);
            if (lexeme("ｅｘｐ"))                       return (T_EXP);
            if (lexeme("ｃｏｓｈ"))                     return (T_COSH);
            ...
            if (lexeme("ａｂｓ"))                       return (T_ZETTAICHI);
            if (lexeme("］"))                           return (T_R_PAREN);
            if (lexeme("［"))                           return (T_L_PAREN);
            ...
            if (lexeme("わってみよ"))                   return (T_WARUTO);
            if (lexeme("わってみい"))                   return (T_WARUTO);
            if (lexeme("わってみぃ"))                   return (T_WARUTO);
            if (lexeme("わってみ"))                     return (T_WARUTO);
            ...
            if (lexeme("やってみい"))                   return (T_SURUTO);
            if (lexeme("やってみぃ"))                   return (T_SURUTO);
            if (lexeme("やってみ"))                     return (T_SURUTO);
            ...
            if (lexeme("もとめてみよ"))                 return (T_SURUTO);
            if (lexeme("もとめてみい"))                 return (T_SURUTO);
            if (lexeme("もとめてみぃ"))                 return (T_SURUTO);
            if (lexeme("もとめてみ"))                   return (T_SURUTO);
            ...
            if (lexeme("まいなすしてみよ"))             return (T_HIKUTO);
            if (lexeme("まいなすしてみい"))             return (T_HIKUTO);
            if (lexeme("まいなすしてみぃ"))             return (T_HIKUTO);
            if (lexeme("まいなすしてみ"))               return (T_HIKUTO);
            ...
            if (lexeme("へいきんち"))                   return (T_AVERAGE);
            if (lexeme("へいきん"))                     return (T_AVERAGE);
            ...
            if (lexeme("ぷらすしてみよ"))               return (T_TASUTO);
            if (lexeme("ぷらすしてみい"))               return (T_TASUTO);
            if (lexeme("ぷらすしてみぃ"))               return (T_TASUTO);
            if (lexeme("ぷらすしてみ"))                 return (T_TASUTO);
            ...
            if (lexeme("ひいてみよ"))                   return (T_HIKUTO);
            if (lexeme("ひいてみい"))                   return (T_HIKUTO);
            if (lexeme("ひいてみぃ"))                   return (T_HIKUTO);
            if (lexeme("ひいてみ"))                     return (T_HIKUTO);
            ...
            if (lexeme("なおしてみよ"))                 return (T_SURUTO);
            if (lexeme("なおしてみなさい"))             return (T_SURUTO);
            if (lexeme("なおしてみい"))                 return (T_SURUTO);
            if (lexeme("なおしてみぃ"))                 return (T_SURUTO);
            if (lexeme("なおしてみ"))                   return (T_SURUTO);
            ...
            if (lexeme("たしてみよ"))                   return (T_TASUTO);
            if (lexeme("たしてみい"))                   return (T_TASUTO);
            if (lexeme("たしてみぃ"))                   return (T_TASUTO);
            if (lexeme("たしてみ"))                     return (T_TASUTO);
            ...
            if (lexeme("たしあわせてみよ"))             return (T_TASUTO);
            if (lexeme("たしあわせてみい"))             return (T_TASUTO);
            if (lexeme("たしあわせてみぃ"))             return (T_TASUTO);
            if (lexeme("たしあわせてみ"))               return (T_TASUTO);
            ...
            if (lexeme("そのあまり"))                   return (T_AMARI);
            if (lexeme("その"))                         return (T_SONO);
            if (lexeme("そうきょくせん"))               return (T_HYPERBOLIC);
            ...
            if (lexeme("してみよ"))                     return (T_SURUTO);
            if (lexeme("してみなさい"))                 return (T_SURUTO);
            if (lexeme("してみい"))                     return (T_SURUTO);
            if (lexeme("してみぃ"))                     return (T_SURUTO);
            if (lexeme("してみ"))                       return (T_SURUTO);
            ...
            if (lexeme("さしひいてみよ"))               return (T_HIKUTO);
            if (lexeme("さしひいてみい"))               return (T_HIKUTO);
            if (lexeme("さしひいてみぃ"))               return (T_HIKUTO);
            if (lexeme("さしひいてみ"))                 return (T_HIKUTO);
            ...
            if (lexeme("さいだいち"))                   return (T_MAX);
            if (lexeme("さいしょーち"))                 return (T_MIN);
            if (lexeme("さいしょうち"))                 return (T_MIN);
            if (lexeme("さい"))                         return (T_SAI);
            if (lexeme("さ"))                           return (T_DIFF);
            if (lexeme("ごく"))                         return (T_GOKU);
            if (lexeme("ごうけい"))                     return (T_SUM);
            ...
            if (lexeme("こたえてみよ"))                 return (T_OSHIETE);
            if (lexeme("こたえてみい"))                 return (T_OSHIETE);
            if (lexeme("こたえてみぃ"))                 return (T_OSHIETE);
            if (lexeme("こたえてみ"))                   return (T_OSHIETE);
            ...
            if (lexeme("こたえて"))                     return (T_OSHIETE);
            if (lexeme("こたえ"))                       return (T_KOTAE);
            if (lexeme("こすう"))                       return (T_COUNT);
            ...
            if (lexeme("くわえてみよ"))                 return (T_TASUTO);
            if (lexeme("くわえてみい"))                 return (T_TASUTO);
            if (lexeme("くわえてみぃ"))                 return (T_TASUTO);
            if (lexeme("くわえてみ"))                   return (T_TASUTO);
            ...
            if (lexeme("かけてみよ"))                   return (T_KAKERUTO);
            if (lexeme("かけてみい"))                   return (T_KAKERUTO);
            if (lexeme("かけてみぃ"))                   return (T_KAKERUTO);
            if (lexeme("かけてみ"))                     return (T_KAKERUTO);
            ...
            if (lexeme("かけあわせてみよ"))             return (T_KAKERUTO);
            if (lexeme("かけあわせてみい"))             return (T_KAKERUTO);
            if (lexeme("かけあわせてみぃ"))             return (T_KAKERUTO);
            if (lexeme("かけあわせてみ"))               return (T_KAKERUTO);
            ...
            if (lexeme("おしえてみよ"))                 return (T_OSHIETE);
            if (lexeme("おしえてみい"))                 return (T_OSHIETE);
            if (lexeme("おしえてみぃ"))                 return (T_OSHIETE);
            if (lexeme("おしえてみ"))                   return (T_OSHIETE);
